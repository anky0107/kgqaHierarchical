"""
Exp 17: Enriched Stage 3 Input for BGE Cross-Encoder
=====================================================
...
CHECKPOINT:    checkpoints/exp17_s3_enriched.pt
METRICS:       metrics/exp17_s3_enriched.csv
"""
...
class EnrichedCDSDataset(Dataset):
    """
    Reads the same JSON format as exp16v2 (exp16_cds_train.json).
...
class EnrichedStage3Trainer:
    ...
    def train(self, dataset: EnrichedCDSDataset, loader: DataLoader,
        ...
        metrics_path = os.path.join(metrics_dir, "exp17_s3_enriched.csv")
        ...
        ckpt = os.path.join(ROOT, "checkpoints", "exp17_s3_enriched.pt")
        torch.save(self.model.state_dict(), ckpt)
        print(f"[Exp17] Checkpoint saved -> {ckpt}")

"""
kg_loader.py — Shared Knowledge Graph Loader for CWQ Subgraph Traversal
=======================================================================

Overview
--------
Provides an in-memory `KnowledgeGraph` class used across the pipeline for 
executing predicted relation paths to retrieve candidate entities.

How it works
------------
Parses all triples from the CWQ dataset SPARQL queries to build an explicit 
in-memory forward/backward dictionary of edges.

Inputs
------
- JSON paths containing CWQ data (with `sparql` fields).
- An `extractor_fn` to parse the SPARQL.

Outputs
-------
- An instantiated `KnowledgeGraph` object used during evaluation.
"""
# ──────────────────────────────────────────────────────
#  Imports
# ──────────────────────────────────────────────────────

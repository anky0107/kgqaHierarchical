"""
evaluate_hit1.py — Correct Hit@1 Evaluation Pipeline
====================================================

Overview
--------
Evaluates the true Hit@1 precision of various planner models (Exp 0–10).
Unlike end-to-end planning accuracy (which uses path-matching), this script
actually executes the predicted path against the Freebase LMDB graph.
...
----------------------
- Used for ablation and intermediate checkpoint checks, generating
  `results_correct_hit1.md`.

Inputs
------
- Processed CWQ JSON files and Freebase LMDB.
- Model checkpoints.

Outputs
-------
- stdout evaluation metrics.
- results_correct_hit1.md
"""
# ─────────────────────────────────────────────────────────────
#  Imports and Config
